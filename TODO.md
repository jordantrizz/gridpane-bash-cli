...
## Domain
* Create new cache command to cache the domains from api for the account.
* Create a new section called Domains and create the commands, get-domains, get-domain <domain>
* Utilize the same cache system as get-sites etc.
* Link domains to sites in the get-sites command output.
* In get-site <site> output, show the domains associated with that site.
* In get-domain <domain> output, show the site associated with that domain.
* In get-sites output, show the primary domain for each site.
